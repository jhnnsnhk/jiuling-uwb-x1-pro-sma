 ...
 *
 */
static inline void warning_iso_c_forbids_an_empty_translation_unit(void)
{
}
/**
 *
...
#define INITIAL_BACKOFF_PERIOD                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
    400 /* This constant would normally smaller (e.g. 1ms), however here it is set to 400 ms so that                                                                                                                                                                                                                                                                                                                                                                                                               \
