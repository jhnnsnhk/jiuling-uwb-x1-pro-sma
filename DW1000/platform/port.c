...
void reset_DW1000(void)
{
    ...
    LL_GPIO_ResetOutputPin(DW1000_GPIO_RST_PRT, DW1000_GPIO_RST_PIN);
#endif

    usleep(1);

#if defined(STM32F103C8TX_UWBX1PRO) || defined(STM32F105RCTX_EVB1000) || defined(STM32F429ZITX_NUCLEO) || defined(STM32H723ZGTX_NUCLEO) || defined(STM32H745ZITX_CM7_NUCLEO) || defined(STM32H753ZITX_NUCLEO) || defined(STM32L432KCUX_NUCLEO)
    LL_GPIO_SetOutputPin(DW1000_GPIO_RST_PRT, DW1000_GPIO_RST_PIN);
#endif
...
{
#if defined(STM32F103C8TX_UWBX1PRO) || defined(STM32F105RCTX_EVB1000) || defined(STM32F429ZITX_NUCLEO) || defined(STM32H723ZGTX_NUCLEO) || defined(STM32H745ZITX_CM7_NUCLEO) || defined(STM32H753ZITX_NUCLEO) || defined(STM32L432KCUX_NUCLEO)
    LL_SPI_Disable(DW1000_SPI_BUS);
    LL_SPI_SetBaudRatePrescaler(DW1000_SPI_BUS, DW1000_SPI_PRESCALER_MIN_SPEED);
    ...
    LL_SPI_StartMasterTransfer(DW1000_SPI_BUS);
#endif
}
...
#if defined(STM32F103C8TX_UWBX1PRO) || defined(STM32F105RCTX_EVB1000) || defined(STM32F429ZITX_NUCLEO) || defined(STM32H723ZGTX_NUCLEO) || defined(STM32H745ZITX_CM7_NUCLEO) || defined(STM32H753ZITX_NUCLEO) || defined(STM32L432KCUX_NUCLEO)
    LL_SPI_Disable(DW1000_SPI_BUS);
    LL_SPI_SetBaudRatePrescaler(DW1000_SPI_BUS, DW1000_SPI_PRESCALER_MAX_SPEED);
    LL_SPI_Enable(DW1000_SPI_BUS);
#endif
#if defined(STM32H723ZGTX_NUCLEO) || defined(STM32H745ZITX_CM7_NUCLEO) || defined(STM32H753ZITX_NUCLEO)
    LL_SPI_StartMasterTransfer(DW1000_SPI_BUS);
